...
/////////////////////////////////
var
    wrapperTop, //追従エリアのトップ位置を格納（追従開始位置
    wrapperHeight, //追従エリアの高さを格納
    sidebarHeight; //サイドバーの高さを格納
    ...
    $(function() {
        ...
        */
        var
            ...
            wrapper = $('#sidebar-scroll'), // スクロール追従要素のID
            side_top_margin = 60;
...
(function($) {
    $(window).scroll(function() {
        ...
        var
            main = $('#main'),
            sharebar_top = sharebar.offset().top,
...
(function($) {
    function adjast_article_like_arrow_box() {
        ...
        main.find('.article-like-arrow-box').css('width', (mw - 114) + 'px');
        sidebar.find('.article-like-arrow-box').css('width', (sw - 114) + 'px');
        //console.log(w);
    }
    $(window).resize(function() {
    ...
    $(function() {
        ...
        wgts.each(function(i, el) {
            ...
            if (has_date_count || has_date_only) {
                ...
                var acv_years = acv.append('<ul class="years">').find("ul.years");
